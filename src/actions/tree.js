...
export const tree = new Baobab({
  ...
  // the org secrets branch of the tree maintains the current secrets for the org

  org_secrets: {},

  // the globacl secrets branch of the tree maintains the current secrets that are global
